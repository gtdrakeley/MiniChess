...
def start(main_int_zeromq, main_str_name):
    ...
    while zeromq_bool_running:
        ...
        if json_in['strFunction'] == 'ping':
            ...
            json_out['boolReturn'] = inline.is_valid(json_in['intY'], json_in['intX'])
            ...
            json_out['boolReturn'] = inline.is_enemy(json_in['strPiece'])
            ...
            json_out['boolReturn'] = inline.is_own(json_in['strPiece'])
            ...
            json_out['boolReturn'] = inline.is_nothing(json_in['strPiece'])

        elif json_in['strFunction'] == 'chess_eval':
            # json_out['intReturn'] = chess.eval()
            # json_out['intReturn'] = ai.eval()
            # json_out['intReturn'] = ai.eval
            json_out['intReturn'] = inline.evaluation()
            ...
            str_out = inline.fw_moves_shuffled()
            json_out['intOut'] = len(str_out)
            json_out['strOut'] = ''.join(str_out)
            ...
            str_out = inline.fw_moves_evaluated()
            json_out['intOut'] = len(str_out)
            json_out['strOut'] = ''.join(str_out)
            ...
            json_out['strOut'] = inline.move_negamax(json_in['intDepth'], json_in['intDuration'])
            ...
            json_out['strOut'] = inline.move_alphabeta(json_in['intDepth'], json_in['intDuration'])
