...
class BoardEvaluator(PieceAnalyzer):
    ...
    def move(self, mv: Move) -> None:
        ...
        if src_piece in PieceAnalyzer.white_pieces:
            ...
            self.black_score -= BoardEvaluator.piece_position_values[dest_piece][5-mv.dest_row][4-mv.dest_column]
            super().move(mv)
            ...
            self.black_score -= BoardEvaluator.piece_position_values[src_piece][5-mv.src_row][4-mv.src_column]
            super().move(mv)
            src_piece = self.board[mv.dest_row][mv.dest_column]
            self.black_score += BoardEvaluator.piece_position_values[src_piece][5-mv.dest_row][4-mv.dest_column]
